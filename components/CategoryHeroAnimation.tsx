...
import { Banknote, ArrowRight, ArrowDown, Wrench } from 'lucide-react'
                            ...
                            >
                                {[2, 1, 0].map((offset) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-[9px] sm:text-[10px] text-white/60 uppercase tracking-widest mt-1">Repair Quote</span>
                                    </motion.div>
                                ))}
                            </motion.div>
                        </AnimatePresence>
